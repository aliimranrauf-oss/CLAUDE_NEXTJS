...
const ADMIN_PIN = 'project3'
const SESSION_KEY = 'p3_admin_unlocked'
  ...
  if (!unlocked) {
    return (
      <div className="mx-auto flex min-h-[70vh] max-w-sm flex-col items-center justify-center px-5 text-center">
        ...
        <h1 className="p3-display mt-4 text-2xl font-semibold text-[var(--p3-ink)]">
          Enter access code
        </h1>
        <p className="mt-2 text-[13px] text-[var(--p3-muted)]">
        ...
        <form onSubmit={handleSubmit} className="mt-6 w-full" autoComplete="off">
          ...
          <button type="submit" className="p3-btn p3-btn-solid mt-4 w-full justify-center">
            Continue →
          </button>
        </form>
        <button
          type="button"
          onClick={unlock}
          className="p3-underline mt-4 text-[12px] text-[var(--p3-muted-2)]"
        >

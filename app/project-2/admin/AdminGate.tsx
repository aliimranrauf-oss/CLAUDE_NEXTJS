...
const ADMIN_PIN = 'project2'
const SESSION_KEY = 'p2_admin_unlocked'
  ...
  if (!unlocked) {
    return (
      <div className="mx-auto flex min-h-[70vh] max-w-sm flex-col items-center justify-center px-5 text-center">
        ...
        <h1 className="p2-display mt-4 text-2xl font-semibold text-[var(--p2-navy)]">
          Enter access code
        </h1>
        ...
        <form onSubmit={handleSubmit} className="mt-6 w-full" autoComplete="off">
          ...
          <button type="submit" className="p2-btn p2-btn-solid mt-4 w-full justify-center">
            Continue →
          </button>
        </form>
        <button

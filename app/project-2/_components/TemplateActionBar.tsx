...
// app/project-2/_components/TemplateActionBar.tsx
//
// Small floating action bar shown on every page of the Project-2 demo site.
...
const ORDER_MESSAGE =
  "Hi! I'd like to order the 'Khalid Al-Mansour' (Finance Executive) portfolio template."
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[60] flex flex-col items-end gap-2 sm:bottom-6 sm:right-6">
      <a
        ...
        className="inline-flex items-center gap-2 rounded-full border border-[var(--p2-gold)] bg-[var(--p2-gold)] px-4 py-2.5 text-[12px] font-semibold text-[var(--p2-navy)] shadow-lg shadow-black/10 transition hover:bg-[var(--p2-gold-soft)] sm:text-[13px]"
      >
      ...
      <a
        href="/careers"
        className="inline-flex items-center gap-2 rounded-full border border-[var(--p2-border-strong)] bg-[var(--p2-panel)]/95 px-4 py-2.5 text-[12px] font-semibold text-[var(--p2-text)] shadow-lg shadow-black/10 backdrop-blur transition hover:border-[var(--p2-gold)] hover:text-[var(--p2-navy)] sm:text-[13px]"
      >

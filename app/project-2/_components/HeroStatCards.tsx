...
export default function HeroStatCards() {
  ...
  const { showRevenueCard, showEbitdaCard, showBudgetCard, showFocusCard } = settings.hero

  if (!showRevenueCard && !showEbitdaCard && !showBudgetCard && !showFocusCard) return null

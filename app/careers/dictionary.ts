    ...
    comparisonGroups: [
      {
        ...
        rows: [
          ...
          { label: 'Custom domain (up to $20/yr) + 1 year hosting', values: [false, false, true] },
        ],
      },
      {
      ...
      },
      {
        ...
        rows: [
          ...
          { label: 'WhatsApp support after delivery', values: ['1 month', '2 months', '6 months'] },
        ],
      },
    ],
    ...
    items: [
      {
        ...
        features: [
          ...
          'دعم عبر واتساب لمدة شهر واحد بعد التسليم',
      ...
      },
      {
        ...
        features: [
          ...
          'دعم عبر واتساب لمدة شهرين بعد التسليم',
      ...
      },
      {
        ...
        features: [
          ...
          'دومين مخصص لموقعك (حتى 20$ سنويًا — تسجيل قياسي)، مع استضافة مجانية لمدة سنة كاملة. الدومينات المميزة أو المعروضة في السوق الثانوي متاحة بتكلفتها الفعلية.',
          'جولة صقل واحدة قبل المقابلات على السيرة الذاتية وLinkedIn والموقع معًا',
          'تسليم بأولوية أسرع من المدة المعتادة',
          'دعم بأولوية عبر واتساب لمدة 6 أشهر بعد التسليم',
    ...
    comparisonGroups: [
      {
        ...
        rows: [
          ...
          { label: 'دومين مخصص (حتى 20$/سنة) + استضافة سنة كاملة', values: [false, false, true] },
        ],
      },
      {
      ...
      },
      {
        ...
        rows: [
          ...
          { label: 'دعم عبر واتساب بعد التسليم', values: ['شهر واحد', 'شهران', '6 أشهر'] },
        ],
      },
    ],

...
export default function HeroPortrait({
  ...
  return (
    <div className="relative">
      ...
      <div className="relative aspect-[4/5] overflow-hidden border border-[var(--p1-line-strong)] bg-[var(--p1-panel)]">
        <Image
          src={src}
          alt={label}
          fill
      ...
      <div className="mt-4 flex items-center justify-between border-t border-[var(--p1-line)] pt-4">
        <span className="p1-mono text-[10px] tracking-widest text-[var(--p1-muted)]">{sublabel}</span>

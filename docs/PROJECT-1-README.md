...
|---|---|---|
| `--p1-bg` | `#0d1117` (near-black steel) | page background |
| `--p1-panel` / `--p1-panel-alt` | `#131a23` / `#1a2330` | card/section backgrounds |
| `--p1-brass` | `#d2a24c` | primary accent — buttons, links, headings, data highlights |
| `--p1-steel` | `#6fa3b8` | secondary accent — category labels, structural motifs |
| `--p1-text` / `--p1-muted` / `--p1-muted-2` | off-white → greys | text hierarchy |
| `--p1-line` / `--p1-line-strong` | translucent white | hairline borders, blueprint grid |
...
- `.p1-draw` — SVG stroke animation that "draws" the skyline in the homepage hero
